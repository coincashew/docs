...
1. Generate a new tz1 account called myPaymentAddress. Add a passphrase to protect it.
...
{% hint style="success" %}
That's it! Every 3 days, reward payments can automatically be distributed from `myPaymentAddress.` Make sure to transfer funds enough tez from your baker address to this payment address.
{% endhint %}
