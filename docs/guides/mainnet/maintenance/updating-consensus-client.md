...
<img src="/img/cl-update.png" alt=""/><p>EthPillar Update</p>
...
<Tabs>
<TabItem value="x" label="Lighthouse | Prysm | Lodestar | Nimbus | Teku" >
```bash
...
<TabItem value="xx" label="Combined BN+VC for Nimbus | Teku" >
```bash
