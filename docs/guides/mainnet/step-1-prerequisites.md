...
<img src="/img/client-stack.png" alt=""/><p>Client Stack</p>

<img src="/img/eth-validator-diagram.png" alt=""/><p>Big picture: Execution / Consensus / Validator</p>
...
<img src="/img/ethereum-inside.png" alt=""/><p>Ethereum Staking Node</p>
...
|   Barrier to Entry   | Plus - Can re-use or re-purpose existing hardwareMinus - Initial cost to purchase new computer equipment                            | Plus - Renting a VPS might require a lower initial investment as you can pay monthly.                                                                                       |
...
|       Security       | Plus - As secure as your home and personal [OPSEC](https://en.wikipedia.org/wiki/Operations\_security)                                             | Plus - Enterprise-grade, professional data centers. Minus - Not your hardware, not your node. It's possible the hosting provide can view your node's contents. |
|        Freedom       | Plus - Do whatever you want. Plan your own upgrades. Minus - With great freedom and power, you are solely responsible for your node. | Plus - Professionally managed. Minus - At the mercy of the host's actions, data center outages are possible.
