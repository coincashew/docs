...
# 📈 Monitoring your node with Grafana and Prometheus
...
<Tabs>
<TabItem value="l" label="Lighthouse" >
![Beacon Chain dashboard by sigp](/img/lhm.png)

![Validator Client dashboard by sigp](/img/lighthouse-validator.png)
...
![LH dashboard by Yoldark](/img/yoldark-lighthouse.png)
...
<TabItem value="n" label="Nimbus" >
![Dashboard by status-im](/img/nim_dashboard.png)

Credits: [https://github.com/status-im/nimbus-eth2/](https://github.com/status-im/nimbus-eth2/)

![Nimbus dashboard by metanull-operator](/img/eth2-grafana-dashboard-prysm.jpg)
...
<TabItem value="t" label="Teku" >
![Teku by PegaSys Engineering](/img/teku.dash.png)

Credits: [https://grafana.com/grafana/dashboards/13457](https://grafana.com/grafana/dashboards/13457)
</TabItem>

<TabItem value="p" label="Prysm" >
![Prysm dashboard by GuillaumeMiralles](/img/prysm_dash.png)
...
![Prysm dashboard by metanull-operator](/img/eth2-grafana-dashboard-prysm.jpg)
...
<Tabs>
<TabItem value="g" label="Geth" >
![Dashboard by karalabe](/img/geth-dash.png)
...
<Tabs>
<TabItem value="x" label="Node-Exporter Dashboard by starsliao" >
